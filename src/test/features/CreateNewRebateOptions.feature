Feature:Retrieve and validate the create new rebate option
  ...
  Background:
    Given User executes the query "deleteContractHeaderByContractName" and "deleteContractDetailByAmendmentName" for contract & Amendment name "QAAutomation%" to delete the record from the database
    And User executes "deleteRebateProgram" query to delete existing rebate program by Contract_ID "ASTRA%" from the database
    And User executes the query "deleteBenefitRule" by benefitRuleName "QAAutomation%" for delete benefit rule by contractID
    And User executes the query "deleteRebateOption" by RebateOptionName "QAAutomation%" for deleting existing rebate option record from DB
  ...
  @Smoke
  Scenario: Create new rebate option using Save Progress API and validate the statusCode
...
#    Then User verify the createNewRebateOptionsSaveProgress response header Error Code value "501"
  ...
  Scenario: Validate the duplicate rebate option is not allowed to create
    And User create new rebate options details
      | mfrRebateOptionName       | startDate  | endDate    | xvalue | yvalue | prodOrMfr | paAndSt | billingCycle | lineOfBusiness | benefitRuleName         | psfOptionLevel | pricingMethod | price | firstRule      | firstCondition | secondRule     | secondCondition | thirdRule | position    | rebateableDrugfirstTier | rebateableDrugcondition | rebateableDrugsecondTier | compFormularyPosition | compDrugTier | compRestrictionsfirstRule | compRestrictionsfirstCondition | compRestrictionssecondRule | compRestrictionssecondCondition | compRestrictionsthirdRule | compRestrictionsthirdCondition | compRestrictionsfourthRule | compRestrictionsfourthCondition | compRestrictionsfifthRule |
      | QAAutomationRebateOptions | 2021-08-01 | 2022-07-20 | 1      | 1      | Product   | true    | MON          | HiEx           | QAAutomationBenefitRule | 1              | PctOfWAC      | 1     | PA_NOT_ALLOWED | AND            | ST_NOT_ALLOWED |                 |           | OnFormulary |                         |                         |                          |                       |              |                           |                                |                            |                                 |                           |                                |                            |                                 |                           |
    Then User hits the "createNewRebateOptionsSaveProgress" with post request of CreateNewRebateOptions save progress API
    Then User verify createNewRebateOptionsSaveProgress status code "200" for the response
    Then User verify the valid createNewRebateOptionsSaveProgress Response body key "isRecordSaved" and expected value "true"
    Then User create new rebate options details
      | mfrRebateOptionName       | startDate  | endDate    | xvalue | yvalue | prodOrMfr | paAndSt | billingCycle | lineOfBusiness | benefitRuleName         | psfOptionLevel | pricingMethod | price | firstRule      | firstCondition | secondRule     | secondCondition | thirdRule | position    | rebateableDrugfirstTier | rebateableDrugcondition | rebateableDrugsecondTier | compFormularyPosition | compDrugTier | compRestrictionsfirstRule | compRestrictionsfirstCondition | compRestrictionssecondRule | compRestrictionssecondCondition | compRestrictionsthirdRule | compRestrictionsthirdCondition | compRestrictionsfourthRule | compRestrictionsfourthCondition | compRestrictionsfifthRule |
      | QAAutomationRebateOptions | 2021-08-01 | 2022-07-20 | 1      | 1      | Product   | true    | MON          | HiEx           | QAAutomationBenefitRule | 1              | PctOfWAC      | 1     | PA_NOT_ALLOWED | AND            | ST_NOT_ALLOWED |                 |           | OnFormulary |                         |                         |                          |                       |              |                           |                                |                            |                                 |                           |                                |                            |                                 |                           |
    Then User hits the "createNewRebateOptionsSaveProgress" with post request of CreateNewRebateOptions save progress API
    Then User verify createNewRebateOptionsSaveProgress status code "200" for the response
  ...
  @Functional @Regression
  Scenario: Validate the Rebate Option dates overlapping with parent program dates is not allowed
    And User create new rebate options details
      | mfrRebateOptionName       | startDate  | endDate    | xvalue | yvalue | prodOrMfr | paAndSt | billingCycle | lineOfBusiness | benefitRuleName         | psfOptionLevel | pricingMethod | price | firstRule      | firstCondition | secondRule     | secondCondition | thirdRule | position    | rebateableDrugfirstTier | rebateableDrugcondition | rebateableDrugsecondTier | compFormularyPosition | compDrugTier | compRestrictionsfirstRule | compRestrictionsfirstCondition | compRestrictionssecondRule | compRestrictionssecondCondition | compRestrictionsthirdRule | compRestrictionsthirdCondition | compRestrictionsfourthRule | compRestrictionsfourthCondition | compRestrictionsfifthRule |
  ...
  @Functional @Regression
  Scenario: Validate the Admin fee must be same as programLevelPsf
    And User create new rebate options details
      | mfrRebateOptionName       | startDate  | endDate    | xvalue | yvalue | prodOrMfr | paAndSt | billingCycle | lineOfBusiness | benefitRuleName         | psfOptionLevel | pricingMethod | price | firstRule      | firstCondition | secondRule     | secondCondition | thirdRule | position    | rebateableDrugfirstTier | rebateableDrugcondition | rebateableDrugsecondTier | compFormularyPosition | compDrugTier | compRestrictionsfirstRule | compRestrictionsfirstCondition | compRestrictionssecondRule | compRestrictionssecondCondition | compRestrictionsthirdRule | compRestrictionsthirdCondition | compRestrictionsfourthRule | compRestrictionsfourthCondition | compRestrictionsfifthRule |
  ...
  @Functional @Regression
  Scenario: Validate with Invalid Program ID
  ...
  @Functional @Regression
  Scenario: Validate that End date less than the start date is Not Allowed
  ...
  @Functional @Regression
  Scenario: Validate with invalid LOB for creating new rebate option save progress and verify correct status code with response body is returned
