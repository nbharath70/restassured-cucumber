...
#
##  Scenario: Hit the Fetch Drug group summary API and verify previouslyApproved drugd from response
##    Given User runs the Query and get the "drugGroupSummaryRowkey" and get the Rowkey of the DrugGroup
##    When User hits the API with Endpoint "fetchDrugListSummary"
...
#    When User hits the API with Endpoint "fetchDrugListSummary"
#    Then User check the Status Code is "200"
#    Then User verify the valid Response FindDrugGroup body key "messageFindDrugGroup" and expected value "No Drug Group Summary found for the drugListRowKey, contact support team." of string
